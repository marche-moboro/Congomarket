...
const TREE_A = [
  ...
  {id:'beaute-cosmetiques-en-gros', label:'Beauté & Cosmétiques en Gros', section:'💄 BEAUTÉ & BIEN-ÊTRE'},
  {id:'parfums-de-luxe-en-gros', label:'Parfums de Luxe en Gros', section:'💄 BEAUTÉ & BIEN-ÊTRE'},
  {id:'savon-artisanal-en-gros', label:'Savon Artisanal en Gros', section:'💄 BEAUTÉ & BIEN-ÊTRE'},
  {id:'produits-eclaircissants-en-gros', label:'Produits Éclaircissants en Gros', section:'💄 BEAUTÉ & BIEN-ÊTRE'},
  {id:'perruques-meches-en-gros', label:'Perruques & Mèches en Gros', section:'💄 BEAUTÉ & BIEN-ÊTRE'},
  {id:'produit-capillaire-en-gros', label:'Produit Capillaire en Gros', section:'💄 BEAUTÉ & BIEN-ÊTRE'},
  {id:'produit-de-bain-en-gros', label:'Produit de Bain en Gros', section:'💄 BEAUTÉ & BIEN-ÊTRE'},
  {id:'sante-bien-etre-femme-en-gros', label:'Santé & Bien-être Femme en Gros', section:'💄 BEAUTÉ & BIEN-ÊTRE'},
  {id:'autre-beaute-bien-etre-gros', label:'Autre', section:'💄 BEAUTÉ & BIEN-ÊTRE'},
...
const TREE_B1 = [
  ...
  {id:'ingenierie', label:'Ingénierie', section:'🏠 MAISON & BTP'},
