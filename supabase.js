...
const TREE_A = [
  ...
  {id:'ag9', label:'🧂 Cube Maggi & Assaisonnements en Carton'},
  {id:'ag10', label:'🐟 Sardines & Conserves de Poisson en Carton'},
  {id:'ag11', label:'💧 Sachets d\'Eau Minérale en Gros'},
  {id:'ag12', label:'🍺 Bière en Carton/Casier'},
  {id:'ag13', label:'🌽 Farine de Maïs en Sac'},
  {id:'gc2', label:'⚫ Charbon de Bois en Gros'},
  {id:'gc3', label:'⛽ Essence/Gasoil en Fût'},
  {id:'te5', label:'☀️ Panneaux Solaires & Kits en Gros'},
  {id:'bs4', label:'➕ Autre'},
];
...
const TREE_B1 = [
  ...
  {id:'marketing-digital', label:'📢 Marketing Digital'},
    {id:'mobile-money', label:'💰 Mobile Money & Transfert d\'Argent'},
  {id:'recharge-tel', label:'📶 Recharge Téléphonique & Forfaits Data'},
  {id:'reparation-tel', label:'🔧 Réparation Téléphone & Tablette'},
  {id:'reparation-pc', label:'🖥️ Réparation Ordinateur'},
  {id:'reparation-tv', label:'📺 Réparation Télévision & Électroménager'},
  {id:'soudure', label:'🔥 Soudure & Ferronnerie'},
  {id:'vulcanisateur', label:'🛞 Vulcanisateur'},
  {id:'tolier', label:'🚗 Tôlier & Carrossier'},
  {id:'serrurier', label:'🔐 Serrurier'},
  {id:'horlogerie', label:'⌚ Horlogerie'},
  {id:'bijoutier', label:'💍 Bijoutier & Orfèvre'},
  {id:'transport-fluvial', label:'🛶 Transport Fluvial'},
  {id:'transport-interurbain', label:'🚌 Transport Interurbain'},
  {id:'location-camion', label:'🚛 Location de Camion & Transport'},
  {id:'elevage', label:'🐓 Élevage (Volaille, Porcs, Chèvres)'},
  {id:'peche-poisson', label:'🎣 Pêche & Vente Poisson Frais'},
  {id:'aquaculture', label:'🐠 Aquaculture'},
  {id:'cours-soutien', label:'📖 Cours de Soutien & Répétiteur'},
  {id:'creche', label:'🧸 Crèche & Garderie'},
  {id:'tresses', label:'💇\u200d♀️ Tresses & Nattes'},
  {id:'tatouage', label:'🎨 Tatouage & Piercing'},
  {id:'tradipraticien', label:'🌿 Tradipraticien & Phytothérapie'},
  {id:'pompes-funebres', label:'🕊️ Pompes Funèbres'},
  {id:'location-materiel-chantier', label:'🏗️ Location de Matériel de Chantier'},
...
const TREE_B2 = [
  ...
  {id:'sape', label:'🕴️ La Sape (Mode Ambianceur)'},
  {id:'liputa', label:'👘 Liputa & Tenues Traditionnelles'},
  {id:'perles-trad', label:'📿 Perles & Bijoux Traditionnels'},
  {id:'carte-sim', label:'📶 Cartes SIM'},
  {id:'pieces-tel', label:'🔩 Pièces & Accessoires Réparation Téléphone'},
  {id:'solaire-detail', label:'☀️ Panneaux Solaires & Kits (Détail)'},
  {id:'composants-electro', label:'⚙️ Composants Électroniques'},
  {id:'eclaircissants', label:'🧴 Produits Éclaircissants & Dépigmentants'},
  ...
  {id:'sacs de voyage, valisette', label:'🧳 Sacs de Voyage'},
  ...
  {id:'manioc', label:'🥔 Manioc, Chikwangue & Foufou'},
  {id:'feuilles-locales', label:'🥬 Feuilles de Manioc & Légumes Locaux'},
  {id:'poisson-sale', label:'🐟 Poisson Salé & Fumé'},
  {id:'chenilles', label:'🐛 Chenilles Séchées'},
  {id:'escargots', label:'🐌 Escargots'},
  {id:'safou', label:'🫒 Safou'},
  {id:'plantain', label:'🍌 Bananes Plantain, Igname & Taro'},
  {id:'arachides', label:'🥜 Arachides & Pâte d\'Arachide'},
  {id:'piment', label:'🌶️ Piment Local'},
  {id:'vin-palme', label:'🍶 Vin de Palme'},
  {id:'miel', label:'🍯 Miel Local'},
  {id:'condiments-detail', label:'🧂 Cube Maggi & Condiments au Détail'},
  {id:'charbon-bois', label:'⚫ Charbon de Bois'},
  {id:'bois-chauffe', label:'🪵 Bois de Chauffe'},
  {id:'petrole-lampant', label:'⛽ Pétrole Lampant & Essence au Détail'},
